...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <x-card>
            ...
            <img src="{{ Storage::url($campaign->path_image) }}" class="img-thumbnail">
        </x-card>
        ...
        <x-card>
            ...
            <div class="progress" style="height: .3rem">
                <div class="progress-bar" role="progressbar" style="width: 7%" aria-valuenow="25" aria-valuemin="0"
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-waktu" role="tabpanel"
                    ...
                    @for ($i = 0; $i < 5; $i++) <div>
                        ...
                        <p class="font-weight-bold mb-0">Ro. {{ format_uang(100000) }}</p>
